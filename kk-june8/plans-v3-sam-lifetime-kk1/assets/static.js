...
(function () {
  ...
  var navMap = {
    'AI Video': '/plans-v3-sam-lifetime-kk1/createvideo.php',
    'Image': '/plans-v3-sam-lifetime-kk1/create-image.php',
    'Audio': '/plans-v3-sam-lifetime-kk1/create-audio.php',
    'Music': '/plans-v3-sam-lifetime-kk1/create-music.php',
    'Upscale': '/plans-v3-sam-lifetime-kk1/create-upscale.php',
    'OmniReels': '/plans-v3-sam-lifetime-kk1/create-omnireels.php',
    'Podcast': '/plans-v3-sam-lifetime-kk1/create-podcast.php',
    'AI Chat': '/plans-v3-sam-lifetime-kk1/create-ai-chat.php',
    'Voice Agents': '/plans-v3-sam-lifetime-kk1/create-voice-agents.php'
  };
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/plans-v3-sam-lifetime-kk1/') >= 0) return '/omnirogue-pages';
