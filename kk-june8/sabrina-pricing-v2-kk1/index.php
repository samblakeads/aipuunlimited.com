      ...
      <nav class="or-nav" aria-label="Primary">
        ...
        <div class="or-nav-inner">
          ...
          <div class="or-nav-links">
            <a class="or-nav-link" href="/sabrina-pricing-v2-kk1/index.php<?= $__step1link; ?>" style="text-decoration:none;">Home</a>
            ...
            <div style="position:relative;">
              ...
              <div class="or-dropdown" role="menu" data-or-dropdown-menu="create-studio">
                <a class="or-dd-item" href="/sabrina-pricing-v2-kk1/createvideo.php<?= $__step1link; ?>" role="menuitem" style="text-decoration:none;">
                ...
                <a class="or-dd-item" href="/sabrina-pricing-v2-kk1/create-image.php<?= $__step1link; ?>" role="menuitem" style="text-decoration:none;">
                ...
                <a class="or-dd-item" href="/sabrina-pricing-v2-kk1/create-audio.php<?= $__step1link; ?>" role="menuitem" style="text-decoration:none;">
                ...
                <a class="or-dd-item" href="/sabrina-pricing-v2-kk1/create-music.php<?= $__step1link; ?>" role="menuitem" style="text-decoration:none;">
                ...
                <a class="or-dd-item" href="/sabrina-pricing-v2-kk1/create-voice-agents.php<?= $__step1link; ?>" role="menuitem" style="text-decoration:none;">
                ...
                <a class="or-dd-item" href="/sabrina-pricing-v2-kk1/create-upscale.php<?= $__step1link; ?>" role="menuitem" style="text-decoration:none;">
                ...
                <a class="or-dd-item" href="/sabrina-pricing-v2-kk1/create-ai-chat.php<?= $__step1link; ?>" role="menuitem" style="text-decoration:none;">
            ...
            <div style="position:relative;">
              ...
              <div class="or-dropdown" role="menu" data-or-dropdown-menu="library">
                <a class="or-dd-item" href="/sabrina-pricing-v2-kk1/gpt-library.php<?= $__step1link; ?>" role="menuitem" style="text-decoration:none;">
                ...
                <a class="or-dd-item" href="/sabrina-pricing-v2-kk1/prompt-library.php<?= $__step1link; ?>" role="menuitem" style="text-decoration:none;">
                ...
                <a class="or-dd-item" href="/sabrina-pricing-v2-kk1/knowledge-base.php<?= $__step1link; ?>" role="menuitem" style="text-decoration:none;">
            ...
            <a class="or-nav-link" href="/sabrina-pricing-v2-kk1/about.php<?= $__step1link; ?>" style="text-decoration:none;">
...
<div class="or-mobile-sheet" data-or-mobile-sheet role="dialog" aria-modal="true" aria-label="Menu">
  <div class="or-mobile-sheet-inner">
    ...
    <div class="or-mobile-list">
      ...
      <a class="or-mobile-item" href="/sabrina-pricing-v2-kk1/index.php<?= $__step1link; ?>" data-or-home-item style="text-decoration:none;">Home</a>
      ...
      <div class="or-footer-inner">
        ...
        <div class="or-footer-top">
          ...
          <div class="or-footer-legal">
            <a class="or-footer-legal-btn" href="/sabrina-pricing-v2-kk1/terms-of-service.php<?= $__step1link; ?>" style="text-decoration:none;">Terms of Service</a>
            <a class="or-footer-legal-btn" href="/sabrina-pricing-v2-kk1/privacy-policy.php<?= $__step1link; ?>" style="text-decoration:none;">Privacy Policy</a>
            <button type="button" class="or-footer-legal-btn" data-or-popup="refund">Refund Policy</button>
            <a class="or-footer-legal-btn" href="/sabrina-pricing-v2-kk1/acceptable-use-policy.php<?= $__step1link; ?>" style="text-decoration:none;">Acceptable Use</a>
            <a class="or-footer-legal-btn" href="/sabrina-pricing-v2-kk1/data-deletion-request.php<?= $__step1link; ?>" style="text-decoration:none;">Data Deletion</a>
          </div>
        </div>
