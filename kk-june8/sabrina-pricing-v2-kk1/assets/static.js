...
(function () {
  ...
  var navMap = {
    'AI Video': '/sabrina-pricing-v2-kk1/createvideo.php',
    'Image': '/sabrina-pricing-v2-kk1/create-image.php',
    'Audio': '/sabrina-pricing-v2-kk1/create-audio.php',
    'Music': '/sabrina-pricing-v2-kk1/create-music.php',
    'Upscale': '/sabrina-pricing-v2-kk1/create-upscale.php',
    'OmniReels': '/sabrina-pricing-v2-kk1/create-omnireels.php',
    'Podcast': '/sabrina-pricing-v2-kk1/create-podcast.php',
    'AI Chat': '/sabrina-pricing-v2-kk1/create-ai-chat.php',
    'Voice Agents': '/sabrina-pricing-v2-kk1/create-voice-agents.php'
  };
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/sabrina-pricing-v2-kk1/') >= 0) return '/omnirogue-pages';
