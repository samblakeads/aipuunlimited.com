...
(function () {
  ...
  var navMap = {
    'AI Video': '/unlimited-plansv3-kk1/createvideo.php',
    'Image': '/unlimited-plansv3-kk1/create-image.php',
    'Audio': '/unlimited-plansv3-kk1/create-audio.php',
    'Music': '/unlimited-plansv3-kk1/create-music.php',
    'Upscale': '/unlimited-plansv3-kk1/create-upscale.php',
    'OmniReels': '/unlimited-plansv3-kk1/create-omnireels.php',
    'Podcast': '/unlimited-plansv3-kk1/create-podcast.php',
    'AI Chat': '/unlimited-plansv3-kk1/create-ai-chat.php',
    'Voice Agents': '/unlimited-plansv3-kk1/create-voice-agents.php'
  };
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/unlimited-plansv3-kk1/') >= 0) return '/omnirogue-pages';
