...
(function () {
  ...
  var navMap = {
    'AI Video': '/pricing-v2-kk1/createvideo.php',
    'Image': '/pricing-v2-kk1/create-image.php',
    'Audio': '/pricing-v2-kk1/create-audio.php',
    'Music': '/pricing-v2-kk1/create-music.php',
    'Upscale': '/pricing-v2-kk1/create-upscale.php',
    'OmniReels': '/pricing-v2-kk1/create-omnireels.php',
    'Podcast': '/pricing-v2-kk1/create-podcast.php',
    'AI Chat': '/pricing-v2-kk1/create-ai-chat.php',
    'Voice Agents': '/pricing-v2-kk1/create-voice-agents.php'
  };
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/pricing-v2-kk1/') >= 0) return '/omnirogue-pages';
