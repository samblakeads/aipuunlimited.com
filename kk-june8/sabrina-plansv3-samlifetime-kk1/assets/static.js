...
(function () {
  ...
  var navMap = {
    'AI Video': '/sabrina-plansv3-samlifetime-kk1/createvideo.php',
    'Image': '/sabrina-plansv3-samlifetime-kk1/create-image.php',
    'Audio': '/sabrina-plansv3-samlifetime-kk1/create-audio.php',
    'Music': '/sabrina-plansv3-samlifetime-kk1/create-music.php',
    'Upscale': '/sabrina-plansv3-samlifetime-kk1/create-upscale.php',
    'OmniReels': '/sabrina-plansv3-samlifetime-kk1/create-omnireels.php',
    'Podcast': '/sabrina-plansv3-samlifetime-kk1/create-podcast.php',
    'AI Chat': '/sabrina-plansv3-samlifetime-kk1/create-ai-chat.php',
    'Voice Agents': '/sabrina-plansv3-samlifetime-kk1/create-voice-agents.php'
  };
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/sabrina-plansv3-samlifetime-kk1/') >= 0) return '/omnirogue-pages';
