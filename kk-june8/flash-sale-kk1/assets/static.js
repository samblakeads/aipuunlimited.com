...
(function () {
  ...
  var navMap = {
    'AI Video': '/flash-sale-kk1/createvideo.php',
    'Image': '/flash-sale-kk1/create-image.php',
    'Audio': '/flash-sale-kk1/create-audio.php',
    'Music': '/flash-sale-kk1/create-music.php',
    'Upscale': '/flash-sale-kk1/create-upscale.php',
    'OmniReels': '/flash-sale-kk1/create-omnireels.php',
    'Podcast': '/flash-sale-kk1/create-podcast.php',
    'AI Chat': '/flash-sale-kk1/create-ai-chat.php',
    'Voice Agents': '/flash-sale-kk1/create-voice-agents.php'
  };
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/flash-sale-kk1/') >= 0) return '/omnirogue-pages';
