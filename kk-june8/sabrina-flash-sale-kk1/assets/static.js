...
(function () {
  ...
  var navMap = {
    'AI Video': '/sabrina-flash-sale-kk1/createvideo.php',
    'Image': '/sabrina-flash-sale-kk1/create-image.php',
    'Audio': '/sabrina-flash-sale-kk1/create-audio.php',
    'Music': '/sabrina-flash-sale-kk1/create-music.php',
    'Upscale': '/sabrina-flash-sale-kk1/create-upscale.php',
    'OmniReels': '/sabrina-flash-sale-kk1/create-omnireels.php',
    'Podcast': '/sabrina-flash-sale-kk1/create-podcast.php',
    'AI Chat': '/sabrina-flash-sale-kk1/create-ai-chat.php',
    'Voice Agents': '/sabrina-flash-sale-kk1/create-voice-agents.php'
  };
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/sabrina-flash-sale-kk1/') >= 0) return '/omnirogue-pages';
