...
(function () {
  ...
  var navMap = {
    'AI Video': '/omnirogue-pages/createvideo.html',
    'Image': '/omnirogue-pages/create-image.html',
    'Audio': '/omnirogue-pages/create-audio.html',
    'Music': '/omnirogue-pages/create-music.html',
    'Upscale': '/omnirogue-pages/create-upscale.html',
    'OmniReels': '/omnirogue-pages/create-omnireels.html',
    'Podcast': '/omnirogue-pages/create-podcast.html',
    'AI Chat': '/omnirogue-pages/create-ai-chat.html',
    'Voice Agents': '/omnirogue-pages/create-voice-agents.html'
  };
  ...
  function omniBasePath() {
    return window.location.pathname.indexOf('/omnirogue-newpages/') >= 0
    ...
    document.querySelectorAll('button, [tabindex="0"]').forEach(function (el) {
      ...
      if (/Explore AI Agents/i.test(text)) {
        ...
        el.addEventListener('click', function () {
          window.location.href = '/omnirogue-pages/createvideo.html';
        });
      }
      if (/View Pricing/i.test(text)) {
        el.style.cursor = 'pointer';
        el.addEventListener('click', function () {
          window.location.href = '/omnirogue-pages/checkout.html';
        });
      }
    });
  }
