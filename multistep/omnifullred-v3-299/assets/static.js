...
(function () {
  ...
  var navMap = {
    'AI Video': '/multistep/omnifullred-v3-299/createvideo.html',
    'Image': '/multistep/omnifullred-v3-299/create-image.html',
    'Audio': '/multistep/omnifullred-v3-299/create-audio.html',
    'Music': '/multistep/omnifullred-v3-299/create-music.html',
    'Upscale': '/multistep/omnifullred-v3-299/create-upscale.html',
    'OmniReels': '/multistep/omnifullred-v3-299/create-omnireels.html',
    'Podcast': '/multistep/omnifullred-v3-299/create-podcast.html',
    'AI Chat': '/multistep/omnifullred-v3-299/create-ai-chat.html',
    'Voice Agents': '/multistep/omnifullred-v3-299/create-voice-agents.html'
  };
  ...
  var __LANDER_BASE = '/multistep/omnifullred-v3-299';
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/multistep/omnifullred-v3-299/') >= 0) return '/omnirogue-pages';
