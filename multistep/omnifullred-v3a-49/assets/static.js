...
(function () {
  ...
  var navMap = {
    'AI Video': '/multistep/omnifullred-v3a-49/createvideo.html',
    'Image': '/multistep/omnifullred-v3a-49/create-image.html',
    'Audio': '/multistep/omnifullred-v3a-49/create-audio.html',
    'Music': '/multistep/omnifullred-v3a-49/create-music.html',
    'Upscale': '/multistep/omnifullred-v3a-49/create-upscale.html',
    'OmniReels': '/multistep/omnifullred-v3a-49/create-omnireels.html',
    'Podcast': '/multistep/omnifullred-v3a-49/create-podcast.html',
    'AI Chat': '/multistep/omnifullred-v3a-49/create-ai-chat.html',
    'Voice Agents': '/multistep/omnifullred-v3a-49/create-voice-agents.html'
  };
  ...
  var __LANDER_BASE = '/multistep/omnifullred-v3a-49';
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/multistep/omnifullred-v3a-49/') >= 0) return '/omnirogue-pages';
