...
(function () {
  ...
  var navMap = {
    'AI Video': '/omnifullred-v3-299-kk/createvideo.php',
    'Image': '/omnifullred-v3-299-kk/create-image.php',
    'Audio': '/omnifullred-v3-299-kk/create-audio.php',
    'Music': '/omnifullred-v3-299-kk/create-music.php',
    'Upscale': '/omnifullred-v3-299-kk/create-upscale.php',
    'OmniReels': '/omnifullred-v3-299-kk/create-omnireels.php',
    'Podcast': '/omnifullred-v3-299-kk/create-podcast.php',
    'AI Chat': '/omnifullred-v3-299-kk/create-ai-chat.php',
    'Voice Agents': '/omnifullred-v3-299-kk/create-voice-agents.php'
  };
  ...
  var __LANDER_BASE = '/omnifullred-v3-299-kk';
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/omnifullred-v3-299-kk/') >= 0) return '/omnirogue-pages';
