...
(function () {
  ...
  var navMap = {
    'AI Video': '/omnifull-plans-v3-299-kk/createvideo.php',
    'Image': '/omnifull-plans-v3-299-kk/create-image.php',
    'Audio': '/omnifull-plans-v3-299-kk/create-audio.php',
    'Music': '/omnifull-plans-v3-299-kk/create-music.php',
    'Upscale': '/omnifull-plans-v3-299-kk/create-upscale.php',
    'OmniReels': '/omnifull-plans-v3-299-kk/create-omnireels.php',
    'Podcast': '/omnifull-plans-v3-299-kk/create-podcast.php',
    'AI Chat': '/omnifull-plans-v3-299-kk/create-ai-chat.php',
    'Voice Agents': '/omnifull-plans-v3-299-kk/create-voice-agents.php'
  };
  ...
  var __LANDER_BASE = '/omnifull-plans-v3-299-kk';
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/omnifull-plans-v3-299-kk/') >= 0) return '/omnirogue-pages';
