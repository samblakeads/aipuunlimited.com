...
(function () {
  ...
  var navMap = {
    'AI Video': '/omnifullred-v3a-49-kk/createvideo.php',
    'Image': '/omnifullred-v3a-49-kk/create-image.php',
    'Audio': '/omnifullred-v3a-49-kk/create-audio.php',
    'Music': '/omnifullred-v3a-49-kk/create-music.php',
    'Upscale': '/omnifullred-v3a-49-kk/create-upscale.php',
    'OmniReels': '/omnifullred-v3a-49-kk/create-omnireels.php',
    'Podcast': '/omnifullred-v3a-49-kk/create-podcast.php',
    'AI Chat': '/omnifullred-v3a-49-kk/create-ai-chat.php',
    'Voice Agents': '/omnifullred-v3a-49-kk/create-voice-agents.php'
  };
  ...
  var __LANDER_BASE = '/omnifullred-v3a-49-kk';
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/omnifullred-v3a-49-kk/') >= 0) return '/omnirogue-pages';
