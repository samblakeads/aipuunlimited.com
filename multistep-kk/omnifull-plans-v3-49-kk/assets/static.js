...
(function () {
  ...
  var navMap = {
    'AI Video': '/omnifull-plans-v3-49-kk/createvideo.php',
    'Image': '/omnifull-plans-v3-49-kk/create-image.php',
    'Audio': '/omnifull-plans-v3-49-kk/create-audio.php',
    'Music': '/omnifull-plans-v3-49-kk/create-music.php',
    'Upscale': '/omnifull-plans-v3-49-kk/create-upscale.php',
    'OmniReels': '/omnifull-plans-v3-49-kk/create-omnireels.php',
    'Podcast': '/omnifull-plans-v3-49-kk/create-podcast.php',
    'AI Chat': '/omnifull-plans-v3-49-kk/create-ai-chat.php',
    'Voice Agents': '/omnifull-plans-v3-49-kk/create-voice-agents.php'
  };
  ...
  var __LANDER_BASE = '/omnifull-plans-v3-49-kk';
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/omnifull-plans-v3-49-kk/') >= 0) return '/omnirogue-pages';
    if (path.indexOf('/aipu-pages/') >= 0) return '/aipu-pages';
    var trimmed = path.replace(/\/$/, '');
    if (trimmed) return trimmed;
    return fromNav || fromScript || '/omnirogue-pages';
  }
  ...
  function omniRegisterCheckoutUrl() {
    ...
    // Customer-facing pages do not load offer tokens; fall back to the
    // lander checkout so library / studio / KB popup CTAs still convert.
    return omniCheckoutUrl();
  }
  ...
  // Global nav targets: Home -> refresh current page, Pricing/Plans -> checkout.
  (function wireTopNav() {
    var CHECKOUT = omniCheckoutUrl();
    var SELF = window.location.pathname + window.location.search;
    document.querySelectorAll('a').forEach(function (a) {
      var label = a.textContent.replace(/\s+/g, ' ').trim();
      var href = a.getAttribute('href') || '';
      // Home link in the top nav — stay on current page (sales / checkout / any).
      if (label === 'Home') {
