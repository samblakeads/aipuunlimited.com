...
<meta name="description" content="Spin the AIPU Prize Vault and unlock 140+ flagship AI tools for $1 today. Limited prize codes available today.">
<meta name="robots" content="noindex,follow">
<link rel="icon" type="image/svg+xml" href="/lander11/assets/favicon.svg">
<link rel="apple-touch-icon" href="/lander11/assets/logo-aipu-mark.png">
...
<div class="stage">
  ...
  <div class="brand-row">
    <a href="/" class="logo" aria-label="AIPU">
      <img src="/lander11/assets/logo-aipu-h.png" alt="AIPU">
    </a>
  </div>
  ...
  <section class="winner" id="winner" aria-hidden="true">
    <div class="winner-card">
      ...
      <div class="claim-code">Claim code <b id="claimCode">AIPU-1PASS</b></div>
  ...
  <footer class="site-foot">
    <div class="sf-inner">
      <img src="/lander11/assets/logo-aipu-h.png" alt="AIPU" class="sf-logo">
      ...
      <p class="sf-fine">
        © 2026 AIPU · AI Power User. All trademarks belong to their respective owners. AIPU is an independent platform providing unified access to third-party AI models under one login. <b>The AIPU Prize Vault is a paid promotional offer. $1 charged today bills your card and starts a 7-day full-access period; standard rate of $15/mo applies after.</b> Cancel anytime in one click. Limit one prize code per household. Offer subject to change without notice.
      </p>
      <div class="sf-badges">
        <span>
