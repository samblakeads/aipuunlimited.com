#!/usr/bin/env python3
"""Shared OmniRogue footer template and link fixes for omni-prototypes/omni-galaxypop."""
import re
...
FOOTER_LINK_FIXES = [
    ...
    (r'href="/about/"', f'href="{LOCAL}/about.html"'),
    (r'href="/omni-prototypes/omni-galaxypop/acceptable-use-policy\.html"', 'href="https://omnirogue.com/acceptable-use-policy"'),
