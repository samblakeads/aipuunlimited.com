...
(function () {
  ...
  var navMap = {
    'AI Video': '/omni-prototypes/omni-galaxypop/createvideo.html',
    'Image': '/omni-prototypes/omni-galaxypop/create-image.html',
    'Audio': '/omni-prototypes/omni-galaxypop/create-audio.html',
    'Music': '/omni-prototypes/omni-galaxypop/create-music.html',
    'Upscale': '/omni-prototypes/omni-galaxypop/create-upscale.html',
    'OmniReels': '/omni-prototypes/omni-galaxypop/create-omnireels.html',
    'Podcast': '/omni-prototypes/omni-galaxypop/create-podcast.html',
    'AI Chat': '/omni-prototypes/omni-galaxypop/create-ai-chat.html',
    'Voice Agents': '/omni-prototypes/omni-galaxypop/create-voice-agents.html'
  };
  ...
  var __LANDER_BASE='/omni-prototypes/omni-galaxypop';
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/omni-prototypes/omni-galaxypop/') >= 0) return '/omni-prototypes/omni-galaxypop';
    if (path.indexOf('/aipu-pages/') >= 0) return '/aipu-pages';
    var trimmed = path.replace(/\/$/, '');
    if (trimmed) return trimmed;
    return fromNav || fromScript || '/omni-prototypes/omni-galaxypop';
  }
