...
Every source file hardcodes `/omni-prototypes/omni-generation/`. Replace across **all** PHP files and `static.js`:

| Find | Replace with |
|---|---|
| `/omni-prototypes/omni-generation/assets/` | `/assets/` |
| `/omni-prototypes/omni-generation/home.html` | `/` or `/index.php` |
| `/omni-prototypes/omni-generation/createvideo.html` | `/createvideo/` |
| `/omni-prototypes/omni-generation/create-image.html` | `/createimage/` |
| `/omni-prototypes/omni-generation/help-center.html` | `/help-center.php` |
| `/omni-prototypes/omni-generation/affiliate.html` | `/affiliate.php` |
| `/omni-prototypes/omni-generation/checkout.html` | `/checkout.php` |
| `/omni-prototypes/omni-generation/gpt-library.html` | `/gpt-library.php` |
| `/omni-prototypes/omni-generation/prompt-library.html` | `/prompt-library.php` |
| `/omni-prototypes/omni-generation/knowledge-base.html` | `/knowledge-base.php` |
| `/omni-prototypes/omni-generation/create-audio.html` | `/create-audio.php` |
| `/omni-prototypes/omni-generation/create-music.html` | `/create-music.php` |
| `/omni-prototypes/omni-generation/create-upscale.html` | `/create-upscale.php` |
| `/omni-prototypes/omni-generation/create-omnireels.html` | `/create-omnireels.php` |
| `/omni-prototypes/omni-generation/create-podcast.html` | `/create-podcast.php` |
| `/omni-prototypes/omni-generation/create-ai-chat.html` | `/create-ai-chat.php` |
| `/omni-prototypes/omni-generation/create-voice-agents.html` | `/create-voice-agents.php` |
| `/omni-prototypes/omni-generation/privacy-policy.html` | `/privacy-policy.php` |
| `/omni-prototypes/omni-generation/terms-of-service.html` | `/terms-of-service.php` |
| `/omni-prototypes/omni-generation/data-deletion-request.html` | `/data-deletion-request.php` |
| `/omni-prototypes/omni-generation/acceptable-use-policy.html` | `/acceptable-use-policy.php` |
| `/omni-prototypes/omni-generation/about.html` | `/about.php` |
...
- [ ] View Source: no remaining `/omni-prototypes/omni-generation/` strings
...
1. **Leaving `/omni-prototypes/omni-generation/` in paths** — breaks CSS, JS, images, and nav.
...
```
Deploy omnirogue-pages on omnirogueapp.com at web root. Keep existing index.php as home — update its HTML to match home.html. Only createvideo and createimage use folders (/createvideo/index.php, /createimage/index.php); all other pages are flat .php files at root. Upload assets/ (main1.css, main2.css, static.js, logo-omnirogue.png, inter.woff2). Replace every /omni-prototypes/omni-generation/ path with root paths per DEPLOY-omnirogueapp.com.md. Use local CSS not omnirogue.com remote chunks. Wire nav: Home→/, Create Studio→/createvideo/, Pricing→/checkout.php, Affiliate→/affiliate.php, Help→/help-center.php. Update static.js LIBRARY_LINKS and verify wireTopNav().
```
