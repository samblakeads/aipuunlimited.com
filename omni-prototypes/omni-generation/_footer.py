...
FOOTER_LINK_FIXES = [
    ...
    (r'href="/about/"', f'href="{LOCAL}/about.html"'),
    (r'href="/omni-prototypes/omni-generation/acceptable-use-policy\.html"', 'href="https://omnirogue.com/acceptable-use-policy"'),
