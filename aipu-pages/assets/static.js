...
(function () {
  'use strict';var __OMNI_SOCIAL_DEFAULT='on';window.__OMNI_SOCIAL_DEFAULT=__OMNI_SOCIAL_DEFAULT;function omniPageExt(){return window.__OMNI_PAGE_EXT||((/\.php([?#]|$)/i.test(window.location.pathname))?'php':'html');}function omniCheckoutUrl(){if(window.__KK_CHECKOUT_URL)return window.__KK_CHECKOUT_URL;return omniBasePath()+'/checkout.'+omniPageExt()+(window.__KK_STEP1LINK||'');}var __OMNI_PAGE_EXT='html';window.__OMNI_PAGE_EXT=__OMNI_PAGE_EXT;var __LANDER_BASE='/aipu-pages';

  var navMap = {
    'AI Video': '/aipu-pages/createvideo.html',
    'Image': '/aipu-pages/create-image.html',
    'Audio': '/aipu-pages/create-audio.html',
    'Music': '/aipu-pages/create-music.html',
    'Upscale': '/aipu-pages/create-upscale.html',
    'AIPU Reels': '/aipu-pages/create-omnireels.html',
    'Podcast': '/aipu-pages/create-podcast.html',
    'AI Chat': '/aipu-pages/create-ai-chat.html',
    'Voice Agents': '/aipu-pages/create-voice-agents.html'
  };
  ...
  // Global nav targets: Home -> home.html, Pricing/Plans -> checkout.html.
  (function wireTopNav() {
    var base = omniBasePath();
    var HOME = base + '/home.html';
    var CHECKOUT = base + '/checkout.html';
  ...
  (function initLibraryDropdown() {
    var base = omniBasePath();
    var gptUrl = base + '/gpt-library.html';
    var promptUrl = base + '/prompt-library.html';
  ...
  (function initGenerateFlow() {
    var base = window.location.pathname.indexOf('/aipu-newpages/') >= 0
      ? '/aipu-newpages' : '/aipu-pages';
    var checkoutUrl = base + '/checkout.html';
    var path = window.location.pathname;
        ...
        '<div id="omni-gen-card">' +
          ...
          '<div class="omni-gen-inner">' +
            ...
            '<div class="omni-gen-ready-only">' +
              ...
              '<p class="omni-gen-claim-sub">Includes ' + studio.label + ' &amp; every AIPU studio &middot; cancel anytime</p>' +
            '</div>' +
          '</div>' +
        '</div>';
