#!/usr/bin/env python3
"""Capture AIPU pages as flat static HTML files in aipu-pages."""
...
SIDEBAR_LINKS = {
    ...
    'AIPU Reels': 'create-omnireels.html',
...
def make_static(html: str, route: str, filename: str) -> str:
    ...
    html = re.sub(r'<script[^>]*src="(?:https://aipu\.com)?/_next/[^"]*"[^>]*></script>', '', html)
    html = re.sub(r'<script[^>]*src="https://clerk\.aipu\.com[^"]*"[^>]*></script>', '', html)
...
"""
    ...
    footer_html = f'''
<footer class="aipu-static-footer" style="padding:2rem 1.5rem;border-top:1px solid rgba(255,255,255,0.08);background:#0b0b14;margin-top:auto">
