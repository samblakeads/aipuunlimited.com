...
<title>AIPU — Introducing SeeDance 2.0 + 140 AI Models From $14.99/mo · app.aiprofessionalsuniversity.com</title>
<meta content="AIPU on app.aiprofessionalsuniversity.com is the all-in-one AI dashboard featuring SeeDance 2.0, ChatGPT Images 2.0, Veo 3.1, Sora 2, GPT-5.5, Claude 4.7, Suno v4 and ElevenLabs — 140+ premium models from $14.99/mo or $399 founders lifetime." name="description"/>
<meta content="AIPU, aipuapp, SeeDance 2.0, ChatGPT Images 2.0, all-in-one AI app, AI video generator, AI image generator, AI voice, AI music, lifetime AI deal" name="keywords"/>
<meta content="AI Profit University LLC" name="author"/>
<meta content="#070812" name="theme-color"/>
<meta content="index, follow, max-image-preview:large" name="robots"/>
<link href="<?= $__checkout; ?>" rel="canonical"/>
<meta content="product" property="og:type"/>
<meta content="AIPU · app.aiprofessionalsuniversity.com" property="og:site_name"/>
<meta content="en_US" property="og:locale"/>
<meta content="/sabrina__plans-v3-299-lifetime__aipu/checkout.php" property="og:url"/>
<meta content="Introducing SeeDance 2.0 + 140 AI Models in One Login — AIPU at app.aiprofessionalsuniversity.com" property="og:title"/>
<meta content="Stop paying $220+/mo across 6 AI tools. AIPU bundles SeeDance 2.0, ChatGPT Images 2.0, Veo 3.1, Sora 2, GPT-5.5, Claude 4.7, Suno v4 and ElevenLabs into one dashboard from $14.99/mo or $399 lifetime." property="og:description"/>
<meta content="/sabrina__plans-v3-299-lifetime__aipu/checkout.php" property="og:image"/>
<meta content="AIPU dashboard preview at app.aiprofessionalsuniversity.com showing the SeeDance 2.0 cinematic video model rendering inside the AIPU all-in-one AI workspace" property="og:image:alt"/>
<meta content="1200" property="og:image:width"/>
<meta content="630" property="og:image:height"/>
<meta content="14.99" property="product:price:amount"/>
<meta content="USD" property="product:price:currency"/>
<meta content="summary_large_image" name="twitter:card"/>
<meta content="@aipu" name="twitter:site"/>
<meta content="@aipu" name="twitter:creator"/>
<meta content="Introducing SeeDance 2.0 + 140 AI Models — AIPU · app.aiprofessionalsuniversity.com" name="twitter:title"/>
<meta content="One login, one price, every premium AI model — including the new SeeDance 2.0 and ChatGPT Images 2.0. From $14.99/mo or $399 founders lifetime at app.aiprofessionalsuniversity.com." name="twitter:description"/>
<meta content="/sabrina__plans-v3-299-lifetime__aipu/checkout.php" name="twitter:image"/>
<meta content="AIPU all-in-one AI dashboard at app.aiprofessionalsuniversity.com — SeeDance 2.0 video render in progress" name="twitter:image:alt"/>
<link href="/sabrina__plans-v3-299-lifetime__aipu/logo-aipu.png" rel="icon" type="image/png"/>
<!-- AIPU checkout chrome -->
<link href="/sabrina__plans-v3-299-lifetime__aipu/_imported/aipu-checkouts/_chrome/chrome.css?v=20260608e" rel="stylesheet"/>
<script type="application/ld+json">
    {
      ...
      "operatingSystem": "Web",
      "description": "All-in-one AI dashboard at app.aiprofessionalsuniversity.com — SeeDance 2.0, ChatGPT Images 2.0, Veo 3.1, Sora 2, GPT-5.5, Claude 4.7, Suno v4, ElevenLabs and 140+ premium AI models for video, image, voice, music, agents and text — under one login.",
      "offers": [
        { "@type": "Offer", "price": "14.99", "priceCurrency": "USD", "name": "AIPU All-Access Monthly", "url": "checkout.html" },
        { "@type": "Offer", "price": "399.00", "priceCurrency": "USD", "name": "AIPU All-Access Lifetime (Founders)", "url": "checkout.html" }
      ],
      "aggregateRating": {
      ...
      "publisher": {
        "@type": "Organization",
        "name": "AI Profit University LLC",
        "url": "checkout.html",
        "email": "support@aiprofessionalsuniversity.com",
        "address": {
          "@type": "PostalAddress",
...
<link href="https://aipu-assets.b-cdn.net/sabrina__plans-v3-299-lifetime__aipu/3225ed00/assets/main1.css" rel="stylesheet"/>
<link href="https://aipu-assets.b-cdn.net/sabrina__plans-v3-299-lifetime__aipu/3225ed00/assets/main2.css" rel="stylesheet"/>
...
<span aria-label="Founders deal countdown" class="countdown" id="topCountdown">
...
<span class="hero-badge"><span class="dot"></span> ★ Introducing SeeDance 2.0 · Now live in AIPU · 140+ premium AI models</span>
<h1>
...
<div class="actions">
<a class="button button-gold" href="<?= $__checkout; ?>">
              Lock In Lifetime — $399 <span class="arrow">→</span>
</a>
<a class="button button-secondary" href="<?= $__checkout; ?>">
...
<div aria-hidden="true" class="dashboard">
<div class="dashboard-header">
<span class="dot r"></span>
<span class="dot y"></span>
<span class="dot g"></span>
<span class="dashboard-url">app.aiprofessionalsuniversity.com / create</span>
</div>
...
<p>97 new creators joined AIPU in the last hour — 38 of them locked in the lifetime founders deal before the price jumps to $599.</p>
</div>
<div aria-live="polite" class="activity-feed">
...
<span class="section-eyebrow">Made inside AIPU</span>
...
<div aria-label="Filter examples" class="gallery-filters" role="tablist">
...
<video class="gallery-media" data-src="https://videos.pexels.com/video-files/3045163/3045163-sd_640_360_25fps.mp4" loop="" muted="" playsinline="" poster="https://images.pexels.com/videos/3045163/free-video-3045163.jpg?auto=compress&amp;cs=tinysrgb&amp;w=600" preload="none">
</video>
...
<img alt="Editorial product hero generated with Flux Pro inside the AIPU dashboard at app.aiprofessionalsuniversity.com" class="gallery-media" decoding="async" loading="lazy" src="https://images.pexels.com/photos/30503923/pexels-photo-30503923.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=800"/>
<div class="gallery-grain"></div>
<div class="gallery-overlay">
...
<video class="gallery-media" data-src="https://videos.pexels.com/video-files/12384689/12384689-sd_640_360_30fps.mp4" loop="" muted="" playsinline="" preload="none">
</video>
<div class="gallery-grain"></div>
<span class="gallery-live">Live</span>
<div class="gallery-overlay">
...
<img alt="Fashion campaign still generated with Imagen 3 inside the AIPU AI image studio" class="gallery-media" decoding="async" loading="lazy" src="https://images.pexels.com/photos/31530959/pexels-photo-31530959.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=800"/>
<div class="gallery-grain"></div>
<div class="gallery-overlay">
...
<video class="gallery-media" data-src="https://videos.pexels.com/video-files/5396816/5396816-sd_640_360_30fps.mp4" loop="" muted="" playsinline="" preload="none">
</video>
<div class="gallery-grain"></div>
<span class="gallery-live">Live</span>
<div class="gallery-overlay">
...
<img alt="Royalty-free lo-fi hip-hop track waveform generated with Suno v4 in AIPU" class="gallery-media" decoding="async" loading="lazy" src="https://images.pexels.com/photos/27459461/pexels-photo-27459461.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=800"/>
<div class="gallery-grain"></div>
<div class="gallery-overlay">
...
<img alt="Moody 35mm portrait generated with Midjourney v7 inside the AIPU dashboard" class="gallery-media" decoding="async" loading="lazy" src="https://images.pexels.com/photos/23911234/pexels-photo-23911234.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=800"/>
<div class="gallery-grain"></div>
<div class="gallery-overlay">
...
<img alt="Studio-grade voiceover waveform from ElevenLabs v3 narration inside AIPU" class="gallery-media" decoding="async" loading="lazy" src="https://images.pexels.com/photos/19144181/pexels-photo-19144181.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=800"/>
<div class="gallery-grain"></div>
<div class="gallery-overlay">
...
<video class="gallery-media" data-src="https://videos.pexels.com/video-files/19428460/19428460-sd_640_360_24fps.mp4" loop="" muted="" playsinline="" preload="none">
</video>
<div class="gallery-grain"></div>
<span class="gallery-live">Live</span>
<div class="gallery-overlay">
...
<img alt="Isometric ceramic architecture render generated with Recraft V3 in AIPU" class="gallery-media" decoding="async" loading="lazy" src="https://images.pexels.com/photos/587994/pexels-photo-587994.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=800"/>
<div class="gallery-grain"></div>
<div class="gallery-overlay">
...
<video class="gallery-media" data-src="https://videos.pexels.com/video-files/1943483/1943483-sd_640_360_25fps.mp4" loop="" muted="" playsinline="" poster="https://images.pexels.com/videos/1943483/free-video-1943483.jpg?auto=compress&amp;cs=tinysrgb&amp;w=600" preload="none">
</video>
<div class="gallery-grain"></div>
<span class="gallery-live">Live</span>
<div class="gallery-overlay">
...
<img alt="Multi-step Claude 4.7 agent workflow output preview from AIPU" class="gallery-media" decoding="async" loading="lazy" src="https://images.pexels.com/photos/30062146/pexels-photo-30062146.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=800"/>
<div class="gallery-grain"></div>
<div class="gallery-overlay">
...
<span class="stat-label">Active creators on AIPU</span>
</div>
<div class="stat-cell">
...
<div class="section-head">
<span class="section-eyebrow">How AIPU works</span>
...
<p class="section-lead">
            Video, image, audio, music, agents, text — every creative pipeline lives inside AIPU. No more juggling 5 subscriptions, 5 logins, 5 monthly invoices.
          </p>
</div>
<div class="studios">
...
<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" viewbox="0 0 24 24"><polygon points="6 4 20 12 6 20 6 4"></polygon></svg>
</div>
...
<div>
<div class="studio-icon">
<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" viewbox="0 0 24 24"><rect height="18" rx="2" width="18" x="3" y="3"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg>
</div>
...
<div>
<div class="studio-icon">
<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" viewbox="0 0 24 24"><path d="M12 1v22"></path><path d="M5 8v8"></path><path d="M19 8v8"></path><path d="M2 12h20"></path><circle cx="12" cy="12" r="3"></circle></svg>
</div>
...
<div>
<div class="studio-icon">
<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" viewbox="0 0 24 24"><path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle></svg>
</div>
...
<div>
<div class="studio-icon">
<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" viewbox="0 0 24 24"><circle cx="12" cy="12" r="10"></circle><path d="M2 12h20"></path><path d="M12 2a15 15 0 0 1 4 10 15 15 0 0 1-4 10"></path><path d="M12 2a15 15 0 0 0-4 10 15 15 0 0 0 4 10"></path></svg>
</div>
...
<div>
<div class="studio-icon">
<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" viewbox="0 0 24 24"><polyline points="4 7 4 4 20 4 20 7"></polyline><line x1="9" x2="15" y1="20" y2="20"></line><line x1="12" x2="12" y1="4" y2="20"></line></svg>
</div>
...
<p class="section-lead">
            From solo founders to brand teams to weekend YouTubers — if you're paying for more than one AI tool right now, AIPU pays for itself in week one.
          </p>
</div>
...
<p class="income-disclaimer" style="margin-top:36px;">
          * Results, savings and time-savings are illustrative and based on individual user-reported experience. Your results will depend on your effort, market, skill level, and how you use the tool. AIPU does not guarantee any specific outcome.
        </p>
</section>
<!-- TRUST / SECURITY BADGES -->
<section class="container section-tight">
...
<p class="section-lead">
            Real results from indie filmmakers, ad agencies, content creators, and brand teams using AIPU daily — verified through independent review platforms.
          </p>
</div>
...
<p>"Our small agency was paying $487/month across 6 AI tools. AIPU is $14.99 and gives us better video, better images, better voice — and frontier text models on top. It's not even close."</p>
...
<p>"I run a faceless YouTube channel. AIPU does the script (Claude), VO (ElevenLabs), b-roll (SeeDance), thumbnail (Flux), and music (Suno). I went from 3 videos a week to 12. Revenue tripled."</p>
...
<div class="testimonial">
<div class="stars">★★★★★ <span class="review-source">Verified · Trustpilot</span></div>
<p>"I've tried every "all-in-one" AI platform. AIPU is the first one where the models are actually the latest versions — Veo 3.1, Sora 2, GPT-5.5, Claude 4.7. Not stripped-down clones. Real frontier."</p>
...
<p>"The router is the secret weapon. I write one prompt and AIPU picks the best model per task — Suno for music, Veo for shots, Flux for product. I never have to remember which app does what."</p>
...
<div class="testimonial featured">
<div class="stars">★★★★★ <span class="review-source">Verified · Product Hunt</span></div>
<p>"I'm a solo founder. AIPU is my entire creative team. Landing pages, ad creative, demo videos, voiceovers, support content — all from $14.99/month. This is unfair leverage for indie hackers. The lifetime deal made me cry."</p>
...
<div class="testimonial">
<div class="stars">★★★★★ <span class="review-source">Verified · Trustpilot</span></div>
<p>"I'm a kindergarten teacher. AIPU writes my lesson plans, makes the read-along videos with voiceover, generates the worksheets, and even composes silly classroom songs with Suno. My students love it."</p>
...
<div class="testimonial">
<div class="stars">★★★★★ <span class="review-source">Verified · G2</span></div>
<p>"I bought lifetime on day 2. Math: I was spending $189/mo on ChatGPT Plus, Midjourney, Runway, and Suno. AIPU lifetime paid for itself in 3 months. Everything since has been pure profit. Best $399 I ever spent."</p>
...
<div class="testimonial">
<div class="stars">★★★★★ <span class="review-source">Verified · Capterra</span></div>
<p>"As an e-com store owner I was hiring freelancers for product photos, ad copy, and video. AIPU killed my $2,300/mo creative budget overnight. Same quality, infinitely faster, and I own everything I make."</p>
...
<p class="section-lead">
            AIPU bundles best-in-class models for every job — video, image, music, voice, agents, and chat. No more 6 subscriptions, 6 logins, 6 invoices.
          </p>
</div>
...
<tr>
<th>Capability</th>
<th class="col-omni">AIPU<br/><span style="font-size:12px;font-weight:700;letter-spacing:0;text-transform:none;opacity:0.85">$14.99/mo</span></th>
...
<div>
<div class="section-eyebrow" style="margin-bottom:0;">AIPU All-Access · Monthly</div>
<div class="price-row">
...
<a class="button button-primary" href="<?= $__checkout; ?>">
...
<div>
<div class="section-eyebrow gold" style="margin-bottom:0;">AIPU All-Access · LIFETIME</div>
<div class="price-row">
...
<div class="bonus-name">AIPU Pro Prompt Library <span class="free">FREE</span></div>
...
<div class="bonus-desc">The exact AIPU workflow our top creator used to triple her channel revenue.*</div>
</div>
<div class="bonus-value">$197 value</div>
</div>
<div class="bonus-row">
...
<div class="bonus-desc">Plug-and-play AIPU templates for Meta &amp; TikTok ads that convert.</div>
</div>
...
<div class="bonus-desc">Monthly small-group calls with the AIPU team — for life.</div>
</div>
...
<p class="section-lead">
            Here's exactly what your AIPU subscription replaces — line by line, with each tool's public retail price.
          </p>
</div>
...
<div aria-hidden="true" class="guarantee-seal">
<div>
...
<div>
<h3>Try AIPU risk-free for 30 days.</h3>
<p>
              Use AIPU as much as you want for 30 full days. <strong>If it doesn't replace at least 3 tools in your AI stack, email us and we refund every cent. No questions, no forms, no callbacks, no hard-sell retention scripts.</strong> The risk is on us — and that goes for both monthly and lifetime members. <a href="#" style="color:var(--accent-2);text-decoration:underline;">Read the full refund policy →</a>
</p>
</div>
</div>
</section>
...
<span class="sig-meta">Founder · ryan@aipu.com</span>
</div>
</div>
</section>
<!-- FAQ -->
...
<p class="section-lead">
            Everything you'd want to ask. Still curious? Email us at <a href="#" style="color:var(--accent-2);text-decoration:underline;">support@aiprofessionalsuniversity.com</a> — a real human replies same day.
          </p>
</div>
<div class="faq-list">
...
<p class="answer">AIPU generates the raw assets — videos, images, audio stems, scripts. Most pros still finish in After Effects, Premiere, Logic, or Photoshop. AIPU replaces the 5+ generative AI subscriptions you currently stitch together, not your editing suite.</p>
</details>
<details class="faq-item">
...
<details class="faq-item">
<summary>Is AIPU affiliated with Facebook / Meta / Google / OpenAI?</summary>
<p class="answer">No. AIPU is an independent platform that integrates with publicly available AI models from multiple providers (OpenAI, Anthropic, Google, Black Forest Labs, ElevenLabs and others). We are not affiliated with, endorsed by, or sponsored by Meta, Facebook, Instagram, Google, OpenAI, Anthropic, or any third-party platform mentioned on this page. All trademarks and product names are the property of their respective owners.</p>
</details>
<details class="faq-item">
<summary>Will I get the same results as the testimonials show?</summary>
<p class="answer">Maybe. Maybe not. The testimonials on this page are real, individual experiences submitted by verified buyers — but they're not typical and not guaranteed. AIPU is a tool. Your results depend on your skill, market, effort, and how you use it. We provide the platform; you provide the work. That's why we offer a 30-day money-back guarantee — try it on us, and if it doesn't work for you, you get every cent back.</p>
</details>
</div>
</section>
<!-- FINAL CTA -->
...
<div aria-live="polite" class="final-countdown">
...
<p>
<strong>Independence disclosure:</strong> This site and AIPU are <strong>not affiliated with, endorsed by, sponsored by, or administered by</strong> Meta Platforms Inc. (Facebook, Instagram, WhatsApp), Google LLC, OpenAI, Anthropic, ElevenLabs, Suno, Runway, Midjourney or any other third-party AI provider mentioned. All product names, logos, and brands are the property of their respective owners and are used here for descriptive purposes only.
          </p>
<p>
<strong>Earnings &amp; results disclaimer:</strong> Any earnings, revenue, ROI, time-saved, traffic, conversion, customer or savings figures shown in testimonials, case studies, screenshots or examples are <strong>individual results</strong>. They are <strong>not typical</strong> and are <strong>not guaranteed</strong>. The average user may experience little or no measurable result. Your outcome depends entirely on your effort, skill, market conditions, business model, and how you use the tool. AIPU does not guarantee any specific income, revenue, ROI, traffic, sales or business outcome of any kind.
          </p>
<p>
...
<!-- chrome:footer -->
<!-- AIPU checkout footer -->
<!-- AIPU trust popup modal (content injected by chrome.js) -->
<div aria-labelledby="or-modal-title" aria-modal="true" class="or-modal-scrim" data-or-modal="" role="dialog">
<div class="or-modal" role="document">
<button aria-label="Close" class="or-modal-close" data-or-modal-close="" type="button">
<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M18 6 6 18"></path><path d="m6 6 12 12"></path></svg>
</button>
<div class="or-modal-eyebrow" data-or-modal-eyebrow=""></div>
<h3 class="or-modal-title" data-or-modal-title="" id="or-modal-title"></h3>
...
<button class="or-modal-cta" data-or-modal-cta="" type="button">
<svg aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
...
<!-- AIPU Affiliate Program — rich popup -->
<div aria-labelledby="or-aff-title" aria-modal="true" class="or-aff-scrim" data-or-aff-modal="" role="dialog">
<div class="or-aff-modal" role="document">
<button aria-label="Close" class="or-aff-close" data-or-aff-close="" type="button">
<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M18 6 6 18"></path><path d="m6 6 12 12"></path></svg>
</button>
<span class="or-aff-eyebrow">
<svg aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><line x1="12" x2="12" y1="2" y2="22"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
          Affiliate Program
        </span>
<h3 class="or-aff-title" id="or-aff-title">
          Earn real money every time you<br/>
<span class="or-aff-title-grad">share AIPU.</span>
</h3>
...
<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
</span>
<div>
...
<div class="or-aff-rule">
<span class="or-aff-rule-icon">
<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path><path d="m9 12 2 2 4-4"></path></svg>
</span>
<div>
...
<div class="or-aff-rule">
<span class="or-aff-rule-icon">
<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><line x1="12" x2="12" y1="2" y2="22"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
</span>
<div>
...
<div class="or-aff-rule">
<span class="or-aff-rule-icon">
<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><rect height="14" rx="2" width="20" x="2" y="5"></rect><line x1="2" x2="22" y1="10" y2="10"></line></svg>
</span>
<div>
<div class="or-aff-rule-title">Withdraw your way</div>
<div class="or-aff-rule-text">Cash out to PayPal, Wise, bank transfer — or apply credit toward your own AIPU plan. No minimum games.</div>
</div>
</div>
</div>
</div>
...
<summary class="or-aff-faq-q">
                How much can I earn?
                <svg aria-hidden="true" class="or-aff-faq-chev" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.4" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</summary>
...
<div class="or-aff-faq-a">PayPal, Wise, or bank transfer — or apply your earnings as credit toward your own AIPU plan. You pick at withdrawal time.</div>
</details>
<details class="or-aff-faq-item">
<summary class="or-aff-faq-q">
...
<div class="or-aff-faq-a">A new customer who clicks your unique affiliate link, creates an AIPU account, and purchases a paid plan within the 30-day attribution window. Self-referrals, refunded purchases, and fraudulent traffic don't count.</div>
</details>
</div>
</div>
<div class="or-aff-foot">
<button class="or-aff-cta-primary" data-or-aff-dashboard="" type="button">
<svg aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><line x1="12" x2="12" y1="2" y2="22"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
            Open your dashboard
          </button>
<button class="or-aff-cta-secondary" data-or-aff-plans="" type="button">
            See the plans
            <svg aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</button>
</div>
...
<script defer="" src="/sabrina__plans-v3-299-lifetime__aipu/_imported/aipu-checkouts/_chrome/chrome.js?v=20260608e"></script>
<!-- /chrome:footer -->
<!-- Sticky mobile CTA -->
<div aria-label="Quick checkout" class="sticky-cta" role="region">
...
<footer class="relative border-t border-border bg-background"><div class="absolute inset-0 bg-linear-to-t from-background via-background-secondary/30 to-transparent pointer-events-none"></div><div class="container container--xl max-w-7xl mx-auto px-4 sm:px-6 relative py-10 sm:py-16"><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-10 sm:mb-16"><div class="sm:col-span-2"><a class="flex items-center mb-4" href="#"><div class="flex-layout flex-row gap-0 items-center h-[42px]"><picture><source srcset="https://aipu-assets.b-cdn.net/sabrina__plans-v3-299-lifetime__aipu/3225ed00/assets/logo-aipu.webp" type="image/webp"/><img alt="AIPU" class="object-contain" data-nimg="1" decoding="async" height="42" loading="lazy" src="https://aipu-assets.b-cdn.net/sabrina__plans-v3-299-lifetime__aipu/3225ed00/assets/logo-aipu.png" srcset="https://aipu-assets.b-cdn.net/sabrina__plans-v3-299-lifetime__aipu/3225ed00/assets/logo-aipu.png 1x, https://aipu-assets.b-cdn.net/sabrina__plans-v3-299-lifetime__aipu/3225ed00/assets/logo-aipu.png 2x" style="color:transparent" width="160"/></picture></div></a><p class="typography typography--body2 text-sm text-(--text-secondary) mb-6 max-w-xs leading-relaxed">Deploy powerful AI agents for content creation, automation, and beyond.</p></div><div><h6 class="typography typography--subtitle2 text-sm font-medium leading-relaxed text-foreground mb-4">Product</h6><div class="stack stack--vertical gap-2.5"><a class="link link--muted link--hover-underline inline-flex items-center gap-1 transition-colors duration-200 text-(--text-secondary) hover:text-foreground no-underline hover:underline underline-offset-4 text-sm" href="/sabrina__plans-v3-299-lifetime__aipu/createvideo.php<?= $__step1link; ?>">AI Agent</a><a class="link link--muted link--hover-underline inline-flex items-center gap-1 transition-colors duration-200 text-(--text-secondary) hover:text-foreground no-underline hover:underline underline-offset-4 text-sm" href="/sabrina__plans-v3-299-lifetime__aipu/createvideo.php<?= $__step1link; ?>">AI Studio</a><a class="link link--muted link--hover-underline inline-flex items-center gap-1 transition-colors duration-200 text-(--text-secondary) hover:text-foreground no-underline hover:underline underline-offset-4 text-sm" href="/sabrina__plans-v3-299-lifetime__aipu/createvideo.php<?= $__step1link; ?>">Create Studio</a><a class="link link--muted link--hover-underline inline-flex items-center gap-1 transition-colors duration-200 text-(--text-secondary) hover:text-foreground no-underline hover:underline underline-offset-4 text-sm" href="/sabrina__plans-v3-299-lifetime__aipu/create-voice-agents.php<?= $__step1link; ?>">Voice Agents</a><a class="link link--muted link--hover-underline inline-flex items-center gap-1 transition-colors duration-200 text-(--text-secondary) hover:text-foreground no-underline hover:underline underline-offset-4 text-sm" href="/sabrina__plans-v3-299-lifetime__aipu/knowledge-base.php<?= $__step1link; ?>">Knowledge Base</a><a class="link link--muted link--hover-underline inline-flex items-center gap-1 transition-colors duration-200 text-(--text-secondary) hover:text-foreground no-underline hover:underline underline-offset-4 text-sm" href="<?= $__checkout; ?>">Pricing</a></div></div><div><h6 class="typography typography--subtitle2 text-sm font-medium leading-relaxed text-foreground mb-4">Resources</h6><div class="stack stack--vertical gap-2.5"><a class="link link--muted link--hover-underline inline-flex items-center gap-1 transition-colors duration-200 text-(--text-secondary) hover:text-foreground no-underline hover:underline underline-offset-4 text-sm" href="/sabrina__plans-v3-299-lifetime__aipu/help-center.php<?= $__step1link; ?>">Community</a><a class="link link--muted link--hover-underline inline-flex items-center gap-1 transition-colors duration-200 text-(--text-secondary) hover:text-foreground no-underline hover:underline underline-offset-4 text-sm" href="<?= $__checkout; ?>">Contact Us</a></div></div><div><h6 class="typography typography--subtitle2 text-sm font-medium leading-relaxed text-foreground mb-4">Legal</h6><div class="stack stack--vertical gap-2.5"><a class="link link--muted link--hover-underline inline-flex items-center gap-1 transition-colors duration-200 text-(--text-secondary) hover:text-foreground no-underline hover:underline underline-offset-4 text-sm" href="/sabrina__plans-v3-299-lifetime__aipu/privacy-policy.php<?= $__step1link; ?>">Privacy Policy</a><a class="link link--muted link--hover-underline inline-flex items-center gap-1 transition-colors duration-200 text-(--text-secondary) hover:text-foreground no-underline hover:underline underline-offset-4 text-sm" href="/sabrina__plans-v3-299-lifetime__aipu/terms-of-service.php<?= $__step1link; ?>">Terms of Service</a><a class="link link--muted link--hover-underline inline-flex items-center gap-1 transition-colors duration-200 text-(--text-secondary) hover:text-foreground no-underline hover:underline underline-offset-4 text-sm" href="/sabrina__plans-v3-299-lifetime__aipu/data-deletion-request.php<?= $__step1link; ?>">Data Deletion Request</a><a class="link link--muted link--hover-underline inline-flex items-center gap-1 transition-colors duration-200 text-(--text-secondary) hover:text-foreground no-underline hover:underline underline-offset-4 text-sm" href="/sabrina__plans-v3-299-lifetime__aipu/acceptable-use-policy.php<?= $__step1link; ?>">Acceptable Use Policy</a></div></div></div><div class="shrink-0 h-[1px] w-full bg-border divider my-4" data-orientation="horizontal" role="none"></div><div class="flex-layout gap-4 items-center justify-between flex-col md:flex-row pt-8"><span class="typography typography--caption text-xs leading-normal text-(--text-muted)">© <!-- -->2026<!-- --> <!-- -->AI Professionals University<!-- --> · <a class="link link--muted link--hover-underline link--external inline-flex items-center gap-1 transition-colors duration-200 text-(--text-secondary) hover:text-foreground no-underline hover:underline underline-offset-4" href="mailto:support@aiprofessionalsuniversity.com" rel="noopener noreferrer" target="_blank">support@aiprofessionalsuniversity.com</a></span><span class="typography typography--caption text-xs leading-normal text-(--text-muted) flex items-center gap-1">Made with <span class="text-accent">❤</span> for creators worldwide</span></div></div></footer>
</div></div>
<script defer="" src="https://aipu-assets.b-cdn.net/sabrina__plans-v3-299-lifetime__aipu/3225ed00/assets/static.js"></script>
