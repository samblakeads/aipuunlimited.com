...
<meta content="OmniRogue Flash Sale: Lifetime access for $399 (reg. $1,900), or start monthly from $14.99. 140+ AI models, 99 prebuilt agents, voice &amp; video studios — one workspace, paid once, kept forever." name="description"/>
<meta content="noindex,nofollow" name="robots"/>
<link href="/lander11__flash-sale__omni/logo-omnirogue.png" rel="icon" type="image/png"/>
...
<div><div class="font-bold text-white">VIP OmniRogue Community</div><div class="text-white/55 text-xs mt-0.5">1,500+ creators, marketers, founders sharing real workflows</div></div>
...
<div class="flex items-start gap-2.5"><svg class="mt-0.5 flex-none" fill="none" height="16" stroke="#34D399" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.4" viewbox="0 0 24 24" width="16"><path d="M20 6 9 17l-5-5"></path></svg><div><b class="text-white flex items-center gap-2">VIP OmniRogue University <span class="fs-plan-tag fs-tag-creator">New</span></b><div class="text-white/55 text-xs mt-0.5">Step-by-step training on prompting, automation, AI workflows.</div></div></div>
<div class="flex items-start gap-2.5"><svg class="mt-0.5 flex-none" fill="none" height="16" stroke="#34D399" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.4" viewbox="0 0 24 24" width="16"><path d="M20 6 9 17l-5-5"></path></svg><div><b class="text-white flex items-center gap-2">VIP OmniRogue Community <span class="fs-plan-tag fs-tag-creator">New</span></b><div class="text-white/55 text-xs mt-0.5">Join 1,500+ creators sharing AI workflows and real client wins.</div></div></div>
</div>
...
<p class="mt-3 text-sm text-white/70 leading-relaxed">Yes. Lifetime VIP is backed by a 30-day unconditional money-back guarantee. Email <a class="text-amber-300 underline" href="mailto:support@omnirogue.com">support@omnirogue.com</a> within 30 days and we'll refund 100% — no questions, no forms. Monthly plans (Creator, Studio, Scale) can be canceled in one click and you won't be billed again.</p>
</details>
<details class="faq-q fs-card p-5">
<summary class="flex items-center justify-between gap-4 font-bold">
...
<span class="inline-flex items-center gap-1"><svg fill="none" height="12" stroke="#34D399" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.4" viewbox="0 0 24 24" width="12"><path d="M20 6 9 17l-5-5"></path></svg>1,500+ creators trust OmniRogue</span>
...
<script defer="" src="/lander11__flash-sale__omni/assets/static.js"></script>
