...
<meta name="description" content="Spin the OmniRogue Prize Vault and unlock 140+ flagship AI tools for $1 today. Limited prize codes available today.">
<meta name="robots" content="noindex,follow">
<link rel="icon" type="image/png" href="/lander11omni/assets/logo-omnirogue-stack.png">
<link rel="apple-touch-icon" href="/lander11omni/assets/logo-omnirogue-stack.png">
...
<noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=684677704074883&ev=PageView&noscript=1" alt=""></noscript>
<!-- End Meta Pixel Code -->
...
<div class="stage">
  ...
  <!-- Brand row -->
  <div class="brand-row">
    <a href="<?= $link['step1link']; ?>" class="logo" aria-label="OmniRogue">
      <img src="/lander11omni/assets/logo-omnirogue-h.png" alt="OmniRogue">
    </a>
  </div>
        ...
        <svg class="wheel-svg" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <g transform="translate(200,200)">
            ...
            <g font-family="Anton, Bebas Neue, Impact, sans-serif" font-weight="700" fill="#fff" text-anchor="middle" letter-spacing="1">
              ...
              <g transform="rotate(135)">
                <text x="0" y="-138" font-size="26" fill="#2a1500" letter-spacing="2">$1</text>
                <text x="0" y="-118" font-size="11" fill="#2a1500" letter-spacing="3">FULL</text>
                <text x="0" y="-104" font-size="11" fill="#2a1500" letter-spacing="3">ACCESS</text>
              </g>
              <g transform="rotate(180)">
              ...
              <g transform="rotate(315)">
                <text x="0" y="-126" font-size="18" fill="#fff">FREE</text>
                <text x="0" y="-108" font-size="14" fill="#cfffe5">TRIAL</text>
              </g>
            </g>
    ...
    <div class="winner-card">
      ...
      <div class="vault-tiers" id="vaultTiers">
        ...
        <article class="tier tier--entry">
          ...
          <a class="tier-cta tier-cta--entry" id="claimBtn" href="<?= $link['step1link']; ?>" data-tier="trial" data-value="1">UNLOCK $1 PASS →</a>
        ...
        <article class="tier tier--lifetime">
          ...
          <a class="tier-cta tier-cta--popular" href="<?= $link['step1link']; ?>" data-tier="lifetime" data-value="399">LOCK LIFETIME · $399 →</a>
        </article>
        ...
        <article class="tier tier--operator">
          ...
          <a class="tier-cta tier-cta--grand" href="<?= $link['step1link']; ?>" data-tier="enterprise" data-value="499">CLAIM OPERATOR PRIZE · $499/mo →</a>
  ...
  <footer class="site-foot">
    <div class="sf-inner">
      <img src="/lander11omni/assets/logo-omnirogue-h.png" alt="OmniRogue" class="sf-logo">
      <p class="sf-tag">Every AI tool. <b>One login.</b> Cancel anytime.</p>
      <nav class="sf-links" aria-label="Footer">
        <a href="<?= $link['step1link']; ?>">Terms</a><span>·</span>
        <a href="<?= $link['step1link']; ?>">Privacy</a><span>·</span>
        <a href="<?= $link['step1link']; ?>">Refund Policy</a><span>·</span>
        <a href="<?= $link['step1link']; ?>">Contact</a><span>·</span>
        <a href="<?= $link['step1link']; ?>">Support</a>
      </nav>
      <p class="sf-fine">
        © 2026 OmniRogue. All trademarks belong to their respective owners. OmniRogue is an independent platform providing unified access to third-party AI models under one login. <b>The OmniRogue Prize Vault is a paid promotional offer. $1 charged today bills your card and starts a 7-day full-access period; standard rate of $15/mo applies after.</b> Cancel anytime in one click. Limit one prize code per household. Offer subject to change without notice.
      </p>
      <div class="sf-badges">
        <span>
...
<div class="sticky-cta" id="stickyCTA">
  ...
  <a href="<?= $link['step1link']; ?>" id="stickyClaim">Unlock →</a>
</div>
