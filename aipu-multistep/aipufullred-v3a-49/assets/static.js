...
(function () {
  ...
  var navMap = {
    'AI Video': '/aipu-multistep/aipufullred-v3a-49/createvideo.html',
    'Image': '/aipu-multistep/aipufullred-v3a-49/create-image.html',
    'Audio': '/aipu-multistep/aipufullred-v3a-49/create-audio.html',
    'Music': '/aipu-multistep/aipufullred-v3a-49/create-music.html',
    'Upscale': '/aipu-multistep/aipufullred-v3a-49/create-upscale.html',
    'AIPU Reels': '/aipu-multistep/aipufullred-v3a-49/create-omnireels.html',
    'Podcast': '/aipu-multistep/aipufullred-v3a-49/create-podcast.html',
    'AI Chat': '/aipu-multistep/aipufullred-v3a-49/create-ai-chat.html',
    'Voice Agents': '/aipu-multistep/aipufullred-v3a-49/create-voice-agents.html'
  };
  ...
  var __LANDER_BASE = '/aipu-multistep/aipufullred-v3a-49';
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/aipu-multistep/aipufullred-v3a-49/') >= 0) return '/aipu-pages';
