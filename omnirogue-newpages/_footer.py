#!/usr/bin/env python3
"""Shared OmniRogue footer template and link fixes for omnirogue-newpages."""
import re
...
FOOTER_LINK_FIXES = [
    ...
    (r'href="https://omnirogue\.com/contact"', f'href="{LOCAL}/contact.html"'),
    (r'href="/contact"', f'href="{LOCAL}/contact.html"'),
    (r'href="/omnirogue-newpages/acceptable-use-policy\.html"', 'href="https://omnirogue.com/acceptable-use-policy"'),
    (r'href="/acceptable-use-policy"', 'href="https://omnirogue.com/acceptable-use-policy"'),
]


def fix_page_links(html: str) -> str:
    """Apply footer and nav link corrections across a page."""
...
def apply_footer(html: str) -> str:
    """Replace simple or native footer with the canonical footer."""
