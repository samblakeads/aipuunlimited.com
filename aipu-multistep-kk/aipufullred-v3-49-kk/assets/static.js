...
(function () {
  ...
  var navMap = {
    'AI Video': '/aipufullred-v3-49-kk/createvideo.php',
    'Image': '/aipufullred-v3-49-kk/create-image.php',
    'Audio': '/aipufullred-v3-49-kk/create-audio.php',
    'Music': '/aipufullred-v3-49-kk/create-music.php',
    'Upscale': '/aipufullred-v3-49-kk/create-upscale.php',
    'AIPU Reels': '/aipufullred-v3-49-kk/create-omnireels.html',
    'Podcast': '/aipufullred-v3-49-kk/create-podcast.php',
    'AI Chat': '/aipufullred-v3-49-kk/create-ai-chat.php',
    'Voice Agents': '/aipufullred-v3-49-kk/create-voice-agents.php'
  };
  ...
  var __LANDER_BASE = '/aipufullred-v3-49-kk';
