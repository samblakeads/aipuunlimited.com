...
(function () {
  ...
  var navMap = {
    'AI Video': '/aipufull-plans-v3-299-kk/createvideo.php',
    'Image': '/aipufull-plans-v3-299-kk/create-image.php',
    'Audio': '/aipufull-plans-v3-299-kk/create-audio.php',
    'Music': '/aipufull-plans-v3-299-kk/create-music.php',
    'Upscale': '/aipufull-plans-v3-299-kk/create-upscale.php',
    'AIPU Reels': '/aipufull-plans-v3-299-kk/create-omnireels.html',
    'Podcast': '/aipufull-plans-v3-299-kk/create-podcast.php',
    'AI Chat': '/aipufull-plans-v3-299-kk/create-ai-chat.php',
    'Voice Agents': '/aipufull-plans-v3-299-kk/create-voice-agents.php'
  };
  ...
  var __LANDER_BASE = '/aipufull-plans-v3-299-kk';
  ...
  function omniBasePath() {
    ...
    if (path.indexOf('/aipufull-plans-v3-299-kk/') >= 0) return '/aipu-pages';
